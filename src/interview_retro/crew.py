"""
InterviewRetroCrew — @CrewBase entry point for the CrewAI deploy system.

This module also exports task description constants used by the backend
InterviewAnalysisCrew (backend/crews/crews.py).
"""
...
# ── CrewBase crew (required by crewai deploy / pre-flight checks) ─────────────
